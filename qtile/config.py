...
keys = [
    ...
    Key([mod], "Shift_L", lazy.spawn("setxkbmap -layout us -variant typo-birman-en -option lv3:ralt_switch")),
    Key([mod], "Shift_R", lazy.spawn("setxkbmap -layout ru -variant typo-birman-ru -option lv3:ralt_switch")),
